...
class TestCNN(nn.Module):
    ...
    def __init__(self, nb_classes=10):
        ...
        self.conv1_2 = nn.Conv2d(64, 64, 3, "same")   # Convolution     -> [128, 128, 64]
                                                      # Pooling         -> [64, 64, 64]
        self.conv2_1 = nn.Conv2d(64, 128, 3, "same")  # Convolution     -> [64, 64, 128]
        self.conv2_2 = nn.Conv2d(128, 128, 3, "same") # Convolution     -> [64, 64, 128]
                                                      # Pooling         -> [32, 32, 128]
        self.conv3_1 = nn.Conv2d(128, 256, 3, "same") # Convolution     -> [32, 32, 256]
        self.conv3_2 = nn.Conv2d(256, 256, 3, "same") # Convolution     -> [32, 32, 256]
        self.conv3_3 = nn.Conv2d(256, 256, 3, "same") # Convolution     -> [32, 32, 256]
                                                      # Pooling         -> [16, 16, 256]

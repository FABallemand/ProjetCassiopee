...
class MocaplabDataset(Dataset):
    """
    PyTorch dataset for the Mocaplab datasets.
    Link: https://rgbd-dataset.cs.washington.edu/dataset.html
    """

    def __init__(self, path, mode, modalities=["rgb"], transformation=DEFAULT_TRANSOFRMATION, train_test_ratio=8, validation_percentage=0.01, nb_imgs=None):
        super().__init__()
        self.path = path
